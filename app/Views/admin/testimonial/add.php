...
<div class="container-fluid pt-0 px-0 my-2">
    <div class="row  rounded  mx-0 d-flex justify-content-center py-4" style=" background-color:#f3f0f0 !important;">
        <div class="col-md-8">
            <h4 class="mb-2 mt-4 text-center text-black"> Fillup the  Testimonial Information</h4>
            ...
            <form action="<?= url_to("admin/testimonial/add") ?>" method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="col-md-12 ">
                        <div class="mb-3">
                            <label for="" class="form-label text-blue">Message </label>
                            <textarea  name="text" class="form-control form-white" rows="3" required><?= old("text") ?></textarea>
                        </div>
                    </div>
                </div>
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="mb-3">
                            ...
                            <img src="<?= base_url("assets/admin/img/testimonial/original/". old("image")) ?>" width="100" height="auto" alt="<?= old("name") ?>">
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
