            ...
            <div class="card mb-4 "> <!--starting card-->
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <h6 class="d-flex flex-sm-row align-items-center">
                        ...
                        <form action="<?= url_to("admin/testimonial") ?>" method="post">
                    ...
                    <a href="<?= url_to("admin/testimonial/add") ?>" class="btn btn-primary"> Add Testimonial</a>
                </div>
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <form action="<?= url_to("admin/testimonial") ?>" method="get" class="px-sm-4 text-center">
                        <div class="d-flex align-items-center px-4">
                            ...
                            <a href="<?= route_to("admin/testimonial") ?>" class="btn btn-sm btn-danger mt-3 mx-1">Reset</a>
                        </div>
                    </form>
                    <div class="table-responsive p-0">
                        <table class="table align-items-center mb-0">
                            ...
                            <tr class="text-center">
                                ...
                                <th class="text-uppercase text-secondary text-xs font-weight-bolder opacity-7">Profile</th>
                            ...
                            <tr class="text-center">
                                ...
                                <td>
                                    <h6 class="mb-0">
                                        <img src="<?= base_url("assets/admin/img/testimonial/compress/". $value["profile"]) ?>" width="150"  class="rounded-circle" height="140" alt="<?= $value["name"] ?>">
                                    </h6>
                                </td>
                                <td>
                                ...
                                <td>
                                    <h6 class="mb-0 text-md text-capitalize"><?= word_limiter($value['apartment_title'],5) ?></h6>
                                </td>
                                <td>
                                    <h6 class="mb-0 text-md text-capitalize"><?= word_limiter($value['text'],5) ?></h6>
                                </td>
                                ...
                                <td class="align-middle">
                                    <a href="<?= url_to("admin/testimonial/edit", $value['id']) ?>" class="badge badge-sm bg-gradient-success">
                                        Edit
                                    </a>
                                    <a href="<?= url_to("admin/testimonial/delete",  $value['id']) ?>" class="badge badge-sm bg-gradient-danger">
                                        Remove
                                    </a>
                                </td>
                            </tr>
                ...
                <?php else: ?>
                    <div class="alert-info text-white alert p-2 text-center mx-4 mt-4" role="alert"><i class="fas fa-exclamation-triangle"></i> No Testimonial Data Found</div>
                    <div class="text-center">
                        <a href="<?= url_to("admin/testimonial/add") ?>" class="btn btn-primary mb-2"> Add Testimonial</a
                    </div>
                <?php endif;?>
            </div>
        </div> <!--ending card-->
