...
<div class="container-fluid pt-0 px-0 my-2">
    <div class="row  rounded  mx-0 d-flex justify-content-center py-4" style=" background-color:#f3f0f0 !important;">
        <div class="col-md-8">
            <h4 class="mb-2 mt-4 text-center text-black"> Update the City Slider Information</h4>
            ...
            <form action="<?= url_to("admin/slider/update") ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    <div class="col-md-6 ">
                        <div class="mb-3">
                            <label for="" class="form-label text-blue">Slider Photo</label>
                            <input type="file" name="image" value="" class="form-control form-white ">
                            <img src="<?= base_url("assets/admin/img/city_slider/".strtolower($data["image_load"])."/". $data["image"]) ?>" width="200" alt="<?= $data["name"] ?>" class="rounded">
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
