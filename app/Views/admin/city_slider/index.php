        ...
        <div class="col-12">
            <div class="card mb-4"> <!--starting card-->
                ...
                <div class="card-header pb-0 d-flex justify-content-between align-items-center">
                    ...
                    <h6 class="d-flex flex-sm-row align-items-center">
                        ...
                        <form action="<?= url_to("admin/slider") ?>" method="post">
                            <select name="per_page" class="form-control-sm form-control" onchange="this.form.submit()" >
                ...
                <div class="card-body px-0 pt-0 pb-2">
                    ...
                    <form action="<?= url_to("admin/slider") ?>" method="get" class="px-sm-4 text-center">
                        <div class="d-flex align-items-center px-4">
                            ...
                            <a href="<?= route_to("admin/slider") ?>" class="btn btn-sm btn-danger mt-3 mx-1">Reset</a>
                        </div>
                    </form>
